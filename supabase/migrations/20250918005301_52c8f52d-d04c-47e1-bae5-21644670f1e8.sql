...
-- Add some sample comments and likes to make the feed feel more active
INSERT INTO public.post_comments (post_id, author_id, author_name, author_role, content) 
SELECT p.id, '00000000-0000-0000-0000-000000000003', 'Michael Chen', 'staff', 'Thanks for sharing this update. Very helpful information.'
FROM public.posts p 
WHERE p.author_name = 'OriComply' 
LIMIT 1;

INSERT INTO public.post_likes (post_id, user_id)
SELECT p.id, '00000000-0000-0000-0000-000000000003'
FROM public.posts p 
WHERE p.author_name = 'Diana Mitchell' 
LIMIT 2;