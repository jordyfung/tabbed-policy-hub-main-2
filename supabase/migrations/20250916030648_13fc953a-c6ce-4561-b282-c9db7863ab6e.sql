-- Update the user_role enum to include super-admin
ALTER TYPE user_role ADD VALUE 'super-admin';
...
-- Update Jordy's role to super-admin (assuming his email is known)
-- You'll need to replace this with the actual email or user_id
